...
import (
	...
	kafkaCluster "github.com/crossplane-contrib/provider-kafka/internal/controller/cluster"
	kafkaNamespaced "github.com/crossplane-contrib/provider-kafka/internal/controller/namespaced"
...
func main() {
	var (
		...
		metricsBindAddress       = app.Flag("metrics-bind-address", "The address the metric endpoint binds to.").Default(":8080").String()
	)
	...
	kingpin.FatalIfError(kafkaCluster.SetupGated(mgr, o), "Cannot setup Kafka cluster controllers")
	kingpin.FatalIfError(kafkaNamespaced.SetupGated(mgr, o), "Cannot setup Kafka namespaced controllers")
