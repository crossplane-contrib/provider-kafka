...
import (
	...
	utils "github.com/crossplane-contrib/provider-kafka/internal/controller/cluster/utils/acl"
	...
	v1alpha1 "github.com/crossplane-contrib/provider-kafka/apis/cluster/acl/v1alpha1"
...
func (c *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	_, ok := mg.(*v1alpha1.AccessControlList)
	if !ok {
