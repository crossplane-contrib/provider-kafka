...
import (
	...
	utils "github.com/crossplane-contrib/provider-kafka/internal/controller/namespaced/utils/topic"
	...
	v1alpha2 "github.com/crossplane-contrib/provider-kafka/apis/namespaced/topic/v1alpha2"
...
func SetupGated(mgr ctrl.Manager, o controller.Options) error {
	...
	}, v1alpha2.TopicGroupVersionKind)
	return nil
}

func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha2.TopicGroupKind)
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		stateMetricsRecorder := statemetrics.NewMRStateRecorder(
			mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &v1alpha2.TopicList{}, o.MetricOptions.PollStateMetricInterval,
		)
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(err, "cannot register MR state metrics recorder for kind v1alpha2.TopicList")
		}
	}

	r := managed.NewReconciler(mgr, resource.ManagedKind(v1alpha2.TopicGroupVersionKind), opts...)
