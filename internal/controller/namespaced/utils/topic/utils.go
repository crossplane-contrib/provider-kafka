...
import (
	"github.com/crossplane-contrib/provider-kafka/apis/namespaced/topic/v1alpha2"
...
func Generate(name string, params *v1alpha2.TopicParameters) *topic.Topic {
	tpc := &topic.Topic{
		Name:              name,
...
func LateInitializeSpec(params *v1alpha2.TopicParameters, observed *topic.Topic) bool {
...
func IsUpToDate(in *v1alpha2.TopicParameters, observed *topic.Topic) bool {
