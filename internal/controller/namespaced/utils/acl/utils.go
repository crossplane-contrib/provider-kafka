...
import (
	"github.com/crossplane-contrib/provider-kafka/apis/namespaced/acl/v1alpha2"
...
func Generate(params *v1alpha2.AccessControlListParameters) *acl.AccessControlList {
...
// supplied Kafka ACLs.
func IsUpToDate(in *v1alpha2.AccessControlListParameters, observed *acl.AccessControlList) bool {
